...
\COPY staging_clean_scores FROM 'db/data/clean_state_scores.csv' WITH (FORMAT csv, HEADER true, NULL '');
...
JOIN reform_scores y ON s.state_id = y.state_id AND y.scored_at = :scored_at
